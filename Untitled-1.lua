...
--// Load UI Module
local UserInterface = require(script.Parent.ui)

--// Setup UI Callbacks
UserInterface:SetCallback(function(settingName, enabled)
    if settingName == "Enabled" then
        Environment.Settings.Enabled = enabled
    elseif settingName == "Team Check" then
        Environment.Settings.TeamCheck = enabled
    elseif settingName == "Wall Check" then
        Environment.Settings.WallCheck = enabled
    elseif settingName == "Auto Block" then
        Environment.Settings.AutoBlock = enabled
    elseif settingName == "Manual Override" then
        Environment.Settings.ManualOverride = enabled
    elseif settingName == "Full Auto" then
        Environment.Settings.FullAuto = enabled
    elseif settingName == "Third Person" then
        Environment.Settings.ThirdPerson = enabled
    end
end)

UserInterface:SetSliderCallback(function(settingName, value)
    ...
    elseif settingName == "Third Person Sensitivity" then
