...
local function CreateUI()
    ...
    return ScreenGui, MainFrame, StatusLabel, EnabledButton, EnabledKnob, ReopenButton
end
...
--// Main Loop
local function Load()
    local ScreenGui, MainFrame, StatusLabel, EnabledButton, EnabledKnob, ReopenButton = CreateUI()
...
function Environment.Functions:Exit()
    ...
    if game.CoreGui:FindFirstChild("TextButton") then
        game.CoreGui.TextButton:Destroy()
    end
...
print("NEWAIMBOT V5 loaded successfully!")
