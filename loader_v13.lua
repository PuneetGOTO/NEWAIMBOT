    ...
    if not loadedScript then
        ...
        task.spawn(function()
            local success, result = pcall(function()
                loadstring(game:HttpGet("https://raw.githubusercontent.com/PuneetGOTO/NEWAIMBOT/main/aimbot_modern_v11.lua"))()
            end)
...
print("Puneet Aimbot Loader V13 已加载！点击屏幕顶部的按钮开始使用。右键可以拖动按钮位置！")
