...
MainButton.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        local success, result = pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/PuneetGOTO/NEWAIMBOT/main/aimbot_modern_v7.lua"))()
        end)
...
print("Puneet Aimbot Loader V7 已加载！点击屏幕顶部的按钮开始使用。")
