...
MainFrame.Size = UDim2.new(0, 300, 0, 400)  -- 更合适的窗口大小
MainFrame.Position = UDim2.new(0.5, -150, 0.5, -200)
MainFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)  -- 更深的背景色
...
TitleBar.Size = UDim2.new(1, 0, 0, 35)  -- 更高的标题栏
TitleBar.BackgroundColor3 = Color3.fromRGB(35, 35, 35)  -- 稍亮的标题栏
...
ContentFrame.Size = UDim2.new(1, -20, 1, -45)  -- 留出边距
